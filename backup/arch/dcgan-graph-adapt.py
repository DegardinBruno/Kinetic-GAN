...
parser.add_argument("--d_interval", type=int, default=3, help="interval of interation for discriminator")
...
#loading the dataset
'''dataset = dset.CIFAR10(root='/media/socialab/bb715954-b8c5-414e-b2e1-95f4d2ff6f3d', download=True,
...
for epoch in range(niter):
    for i, (data, _) in enumerate(dataloader):
        ...
        if batches_done % 100 == 0:
            ...
            sample_image(real_cpu, os.path.join(images_out,"real_%d.npy") % batches_done)
            fake = netG(fixed_noise)
            sample_image(fake, os.path.join(images_out,"%d.npy") % batches_done)
