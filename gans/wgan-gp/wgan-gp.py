...
parser.add_argument("--n_classes", type=int, default=10, help="number of image channels")
...
class Generator(nn.Module):
    def __init__(self):
        ...
        self.model = nn.Sequential(
            *block(opt.n_classes + opt.latent_dim, 128, normalize=False),
            *block(128, 256),
            *block(256, 512),
            *block(512, 1024),
    ...
    for i, (imgs, labels) in enumerate(dataloader):
        ...
        if i % opt.n_critic == 0:
            ...
            if batches_done % opt.sample_interval == 0:
                ...
                savemat('loss.mat', {'d_loss': loss_d, 'g_loss': loss_g})
