...
for epoch in range(niter):
    for i, data in enumerate(dataloader, 0):
        ...
        if i % 100 == 0:
            ...
            vutils.save_image(real_cpu, os.path.join(images_out,'real_samples.png'),normalize=True)
            fake = netG(fixed_noise)
            vutils.save_image(fake.detach(),os.path.join(images_out,'fake_samples_epoch_%03d.png' % (epoch)),normalize=True)
