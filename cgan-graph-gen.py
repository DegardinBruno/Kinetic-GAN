...
parser.add_argument("--gen_model_path", type=str, default="runs/cgan-graph/ntu-epoch1000/models/generator_2320000.pth", help="path to gen model")
parser.add_argument("--disc_model_path", type=str, default="runs/cgan-graph/ntu-epoch1000/models/discriminator_2320000.pth", help="path to gen model")
